...
| :------------: | :-----------------: | :-------------------------------------------------------------------------------------------------: |
| 🐍 **Python**  |        3.12+        | [![Python](https://img.shields.io/badge/Required-3.12+-blue?style=flat-square)](https://python.org) |
|   💻 **OS**    | Windows/Linux/MacOS |           [![OS](https://img.shields.io/badge/Cross-Platform-green?style=flat-square)](#)           |
|   🧠 **RAM**   |     4GB minimum     |           [![RAM](https://img.shields.io/badge/4GB-Minimum-orange?style=flat-square)](#)            |
| 🌐 **Network** |  TCP connectivity   |          [![Network](https://img.shields.io/badge/TCP-Required-red?style=flat-square)](#)           |
